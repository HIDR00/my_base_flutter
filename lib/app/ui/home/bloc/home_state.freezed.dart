...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({this.isLoading = false, this.messenger = ''});
  ...
  @override
  String toString() {
    return 'HomeState(isLoading: $isLoading, messenger: $messenger)';
  }
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({final bool isLoading, final String messenger}) =
      _$HomeStateImpl;
